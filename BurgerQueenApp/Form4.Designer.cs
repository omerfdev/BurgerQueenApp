namespace BurgerQueenApp
{
	partial class Form4
	{
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Location = new Point(422, 112);
			...
			btnAddExtraProduct.Location = new Point(154, 204);
			...
			// txtbxMenu
			// 
			txtbxMenu.Location = new Point(154, 112);
			...
			// 
			numericUpDownMenuPrice.Location = new Point(154, 160);
