namespace BurgerQueenApp
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			lblTotalCoast.BackColor = Color.OliveDrab;
			...
			// btnOrderAdd
			// 
			btnOrderAdd.BackColor = Color.OliveDrab;
			...
			lblMQQOFORDER.BackColor = Color.OliveDrab;
			...
			radioButtonLargeSize.BackColor = Color.OliveDrab;
			...
			radioButtonLargeSize.UseVisualStyleBackColor = false;
			// 
			// radioButtonMediumSize
			// 
			radioButtonMediumSize.AutoSize = true;
			radioButtonMediumSize.BackColor = Color.OliveDrab;
			...
			radioButtonMediumSize.UseVisualStyleBackColor = false;
			// 
			// radioButtonSmallSize
			// 
			radioButtonSmallSize.AutoSize = true;
			radioButtonSmallSize.BackColor = Color.OliveDrab;
			...
			radioButtonSmallSize.UseVisualStyleBackColor = false;
			// 
			// cmBoxMenu
			// 
			...
			// btnFinishOrder
			// 
			btnFinishOrder.BackColor = Color.OliveDrab;
